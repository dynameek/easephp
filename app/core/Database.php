<?php
    ...
    */
    ...
    class Database
    {
        protected $handle;      #   This would hold the connection resource
        ...
        public function __construct()
        {
            ...
            #   The credential file holds database connection parameters
            $credentialFile = './app/core/credentials.php';
            if(file_exists($credentialFile))
            {
                require_once $credentialFile;
                $this->handle = mysqli_connect(DB_HOST, DB_USER, DB_PASS);  #   Open Database Connection
            }else   $this->dbError = 'Database Credentials file does not exist';
        }
